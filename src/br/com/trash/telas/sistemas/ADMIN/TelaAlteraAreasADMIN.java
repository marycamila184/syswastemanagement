 ...
 * @author Wendel
 */
public class TelaAlteraAreasADMIN extends javax.swing.JFrame {
    int codUpdate;
    ...
    private void initComponents() {
        ...
        campoCodSup.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                campoCodSupKeyPressed(evt);
            }
        });
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
       ...
       String desc=campoDescicao.getText();
       String mun=campoMunicipio.getText();
       String ruas=campoRuas.getText();
       String fiscaisR=campoFiscaisR.getText();
       String fiscaisL=campoFiscaisL.getText();
       String sigla=campoSigla.getText();
       String ext=campoExtensao.getText();
       Object c=campoCodSup.getText();
       String cs=""+c;
       int cods=Integer.parseInt(cs);
       pu.updateAreaADMIN(codUpdate, dataAltera, desc, mun, ruas, fiscaisR, fiscaisL, 
               sigla, ext, cods);
       JOptionPane.showMessageDialog(null, "Alterado com sucesso!");
       dispose();
    }//GEN-LAST:event_botaoSalvarActionPerformed

    private void campoCodSupKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_campoCodSupKeyPressed
         if (evt.getKeyCode() == KeyEvent.VK_ENTER) {  
            String cod=campoCodSup.getText();
            int codS= Integer.parseInt(cod);
            String nome=ps.selectComboFuncionario(codS);
            campoNomeSup.setText(nome);
        }
    }//GEN-LAST:event_campoCodSupKeyPressed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaAlteraAreasADMIN().setVisible(true);
            }
        });
    }
