 ...
 * @author Wendel
 */
public class TelaAlteraServicosADMIN extends javax.swing.JFrame {
    int codUpdate=0;
     ...
     * 
     */
    public TelaAlteraServicosADMIN() {
        initComponents();
    ...
    private void initComponents() {
        ...
        botaoCancelar.setFont(botaoCancelar.getFont().deriveFont((float)12));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(campoUserAltera, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        pu.updateTelaAlteraServicosADMIN(codUpdate, undMensal, qtde, descricao, dataAltera);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlteraServicosADMIN().setVisible(true);
            }
        });
    }
