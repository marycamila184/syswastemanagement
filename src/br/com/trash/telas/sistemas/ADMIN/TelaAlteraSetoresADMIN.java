 ...
 * @author Wendel
 */
public class TelaAlteraSetoresADMIN extends javax.swing.JFrame {
    int codUpdate=0;
    ...
    private void initComponents() {
        ...
        campoInclusao = new javax.swing.JTextField();
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addComponent(campoInclusao, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(42, 42, 42)
                .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(campoDataInclusao, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(53, 53, 53))
        );
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
       ...
       String descricao=campoDescricaoSet.getText();
       pu.updateTelaAlteraSetoresADMIN(codUpdate, municipio, sigla, 
               descricao, dataAltera);
       dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlteraSetoresADMIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaAlteraSetoresADMIN().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField campoInclusao;
    ...
    public void preencheCampos(setoresBean sb) {
        ...
        campoDataInclusao.setText(sb.getDataInclusao());
