 ...
 * @author Wendel
 */
public class TelaAlteraFuncionariosADMIN extends javax.swing.JFrame {
     ...
     * 
     */
    public TelaAlteraFuncionariosADMIN() {
        initComponents();
    ...
    private void initComponents() {
        ...
        comboboxNivel.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        comboboxNivel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "admin", "diretoria", "comum" }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(campoUser, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
        ...
        comboboxTurno.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Escolha o Turno", "Diurno", "Noturno" }));
        ...
        radiobotaoFiscal.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                radiobotaoFiscalMouseClicked(evt);
            }
        });
        ...
        radiobotaoSupervisor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                radiobotaoSupervisorMouseClicked(evt);
            }
        });
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        String n=""+nivel;
        boolean alteraSenha=checkboxAlteraSenha.isSelected();
        if(alteraSenha==true){
            altera="s";
        }  
        if(radiobotaoFiscal.isSelected()){
            funcao="Fiscal";
            usuario="";
            senha="";
        }else
            if(radiobotaoFuncionario.isSelected()){
               funcao="Funcionario";
               usuario=campoUser.getText();
               senha=String.valueOf(campoSenha.getPassword());
            }else
                if(radiobotaoSupervisor.isSelected()){
                   funcao="Supervisor";
                   usuario="";
                   senha="";
              }
        ...
        pu.updateTelaAlteraFuncionariosADMIN(codUpdate, dataAltera, nome, morada, telemovel, contribuinte, 
                t, n, altera, funcao, usuario, senha, status);
    }//GEN-LAST:event_botaoSalvarActionPerformed

    private void radiobotaoFiscalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_radiobotaoFiscalMouseClicked
        campoUser.setText("");
        campoSenha.setText("");   
    }//GEN-LAST:event_radiobotaoFiscalMouseClicked

    private void radiobotaoSupervisorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_radiobotaoSupervisorMouseClicked
        campoUser.setText("");
        campoSenha.setText("");   
    }//GEN-LAST:event_radiobotaoSupervisorMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlteraFuncionariosADMIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaAlteraFuncionariosADMIN().setVisible(true);
            }
        });
    }
