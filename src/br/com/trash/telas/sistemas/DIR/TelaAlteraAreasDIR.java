 ...
 * @author Wendel
 */
public class TelaAlteraAreasDIR extends javax.swing.JFrame {
    int codUpdate;
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
       ...
       pu.updateAreaDIR(codUpdate, dataAltera, desc, mun, ruas,  
                ext, cods);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaAlteraAreasDIR().setVisible(true);
            }
        });
    }
