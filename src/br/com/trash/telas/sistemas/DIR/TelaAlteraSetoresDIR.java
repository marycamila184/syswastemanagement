 ...
 * @author Wendel
 */
public class TelaAlteraSetoresDIR extends javax.swing.JFrame {
    int codUpdate;
    persistenciaUpdate pu=new persistenciaUpdate();
    /**
     * Creates new form TelaInicial
     */
    public TelaAlteraSetoresDIR() {
        initComponents();
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
       ...
       pu.updateTelaAlteraSetoresDIR(codUpdate, municipio, sigla, 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaAlteraSetoresDIR().setVisible(true);
            }
        });
    }
