 ...
 * @author Wendel
 */
public class TelaAlteraFornecedoresDIR extends javax.swing.JFrame {
    persistenciaUpdate pu=new persistenciaUpdate();
    int codUpdate=0;
    /**
     * 
     */
    public TelaAlteraFornecedoresDIR() {
        initComponents();
    ...
    private void initComponents() {
        ...
        campovalidadeContrato.setEnabled(false);
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(campoNIF, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
       ...
       pu.updateTelaFornecedoresDIR(codUpdate, razao, morada, municipio, bairro, 
               telemovel, telemovel2, email, dataAltera);
       dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlteraFornecedoresDIR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlteraFornecedoresDIR().setVisible(true);
            }
        });
    }
  ...
  public void preencheCamposFornecedores(EntityManagerFactory factory, EntityManager manager, int cod) {
    ...
    public void preencheCampos(fornecedoresBean fb) {
        ...
        campovalidadeContrato.setText(fb.getDataContrato());
