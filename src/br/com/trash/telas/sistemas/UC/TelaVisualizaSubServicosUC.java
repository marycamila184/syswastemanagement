 ...
 * @author Wendel
 */
public class TelaVisualizaSubServicosUC extends javax.swing.JFrame {
    persistenciaSelect ps=new persistenciaSelect();
    /**
     * 
     */
    public TelaVisualizaSubServicosUC() {
        initComponents();
    ...
    private void initComponents() {
        ...
        campoDescricaoSubServico.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaVisualizaSubServicosUC().setVisible(true);
            }
        });
    }
