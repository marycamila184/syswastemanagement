 ...
 * @author Wendel
 */
public class TelaVisualizaServicosUC extends javax.swing.JFrame {
     ...
     */
    public TelaVisualizaServicosUC() {
        initComponents();
    ...
    private void initComponents() {
        ...
        campoUndMensal.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaVisualizaServicosUC().setVisible(true);
            }
        });
    }
